                                    ...
                                    <Row>
                                        <i-col span="18">
                                            <form-item label="名称" prop="name" >
                                                <i-input  v-model="dataConfig.name" placeholder="请填访问控制名称" :disabled=true  style="margin-left:10px;"></i-input>
                                            </form-item>
                                        </i-col>
                                    </Row>
                                </div>
                                ...
                                <Row>
                                    <i-col span="24">
                                      <form-item label="优先级" prop="name">
                                       <Input-number :max="10" :min="1" :value="dataConfig.priority" style="margin-left:10px;"></Input-number>
                                       </form-item>
                                    </i-col>
                                </Row>
                                  <Row>
   ...
   mounted () {
    ...
    methods: {
        ...
        getModify(){
            ...
            this.$axios.put('http://10.0.0.19:8081/apis/linkingthing.com/example/v1/views/'+this.id1,{
