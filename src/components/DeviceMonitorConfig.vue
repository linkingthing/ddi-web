                                    ...
                                    <Row>
                                        <i-col span="18">
                                            <form-item label="名称" prop="name" >
                                                <i-input  v-model="dataConfig.name" placeholder="请填访问控制名称" style="margin-left:10px;"></i-input>
                                            </form-item>
                                        </i-col>
                                    </Row>
                                </div>
   ...
   mounted () {
    ...
    methods: {
        ...
        update(){
            ...
            this.$axios.post('http://10.0.0.19:8081/apis/linkingthing.com/example/v1/views',{
