                    ...
                    <Row>
                        <i-col span="18">
                            <form-item label="递归并发数" prop="recursiveClients" style="font-size:20px;">
                                <i-input  v-model="formItem.recursiveClients"  style="margin-left:10px; width:300px;"></i-input><span>个</span>
                            </form-item>
                        </i-col>
                         <i-col span="18">
                            <form-item label="单一域递归并发数" prop="fetchesPerZone" style="font-size:20px;">
                                <i-input  v-model="formItem.fetchesPerZone"  style="margin-left:10px; width:300px;"></i-input><span>个</span>
                            </form-item>
                        </i-col>
                        <i-col span="18">
...
export default {
    ...
    methods: {
     getView(){
        this.$axios.get('http://10.0.0.19:8081/apis/linkingthing.com/example/v1/recursiveconcurrents', {
          })
          .then(res => {
        ...
        // 保存
        primary(){
            this.$axios.put('http://10.0.0.19:8081/apis/linkingthing.com/example/v1/recursiveconcurrents/con',{
